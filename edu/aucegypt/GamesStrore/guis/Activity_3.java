...
public class Activity_3 
{
    ...
    LoginFrame = new JFrame(Strings.activity3Name);
    ...
    ActionListener buttonHandler = new Activity_3Controller(LoginFrame, userTypeCheckBox, usernameField, passwordField, emailField);
    ...
    protected static void reDirectMsg()
    {
        ...
        ActionListener closeDirectingListener = new Activity_3Controller(LoginFrame, userTypeCheckBox, usernameField, passwordField, emailField);
